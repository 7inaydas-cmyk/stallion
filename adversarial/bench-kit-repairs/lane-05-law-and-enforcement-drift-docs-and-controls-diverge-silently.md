# Adversarial pass — task bench-kit-repairs — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 tools/bench/grade.mjs | 16 +++++++++-------
 tools/bench/setup.mjs | 16 +++++++++-------
