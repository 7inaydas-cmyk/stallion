# Adversarial pass — task ecc-efficiency-shapes — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 tools/adversarial-runner.mjs |  5 ++-
 tools/task-findings.mjs      | 32 +++++++++++++++-
