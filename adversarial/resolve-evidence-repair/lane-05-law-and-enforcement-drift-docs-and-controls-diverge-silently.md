# Adversarial pass — task resolve-evidence-repair — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 tasks/ci-stepname-drift-repair.findings.json | 11 ++++-
 tasks/resolve-evidence-repair.json           | 61 ++++++++++++++++++++++++++++
 tools/adversarial-runner.mjs                 | 15 +++++--
 tools/task-findings.mjs                      | 60 +++++++++++++++++++++++++--
 tools/task-state.mjs                         |  2 +-
 5 files changed, 138 insertions(+), 11 deletions(-)

```

Files touched:
tasks/ci-stepname-drift-repair.findings.json
tasks/resolve-evidence-repair.json
