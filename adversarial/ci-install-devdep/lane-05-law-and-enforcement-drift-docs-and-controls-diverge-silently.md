# Adversarial pass — task ci-install-devdep — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 .github/workflows/selftest.yml |  4 +++-
 docs/decisions/DECISIONS.md    | 10 +++++++++
 tasks/ci-install-devdep.json   | 50 ++++++++++++++++++++++++++++++++++++++++++
