# Adversarial pass — task ecc-intervention-gate — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 ...
 docs/WIRING.md          |  34 +++++-
 package.json            |   7 +-
 tools/task-coverage.mjs |  72 ++++++++++++-
 tools/task-gate.mjs     | 274 ++++++++++++++++++++++++++++++++++++++++++++++++
