# Adversarial pass — task transport-agreement — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 package.json                               |   2 +-
 tools/zcode-plugin/lib/agreement-check.mjs | 125 +++++++++++++++++++++++++++++
