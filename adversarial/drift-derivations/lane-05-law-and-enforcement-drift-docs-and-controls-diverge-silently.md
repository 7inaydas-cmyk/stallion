# Adversarial pass — task drift-derivations — lane 5: Law-and-enforcement drift — docs and controls diverge silently
...
```
 tools/task-workspace.mjs            |  9 ++++++---
 tools/zcode-plugin/lib/gate-law.mjs | 24 +++++++++++++++++++-----
